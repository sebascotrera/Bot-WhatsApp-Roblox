...
const {
  ...
  */
  ...
  〘 *BOT* 〙
  ‣ Prefijo:  *「 ${prefix} 」*
  ‣ Yo soy: ✨El Bot de adopt me Trades ✨
  ‣ Conección: *1V*
  ...
  *〘 TEXT0 〙*
  ...
  ┃ _Ex : ${prefix}Tahta Adopt me Trades_
  ┗━━━━━━━━━━━━━━━━━━━━
  *〘 TEXTO2 〙*
  ┏━━━━━━━━━━━━━━━━━━━━
  ...
  ┃ _Ex : ${prefix}Ephoto 25 Adopt me Trades_
  ┠⊷️ *${prefix}Textpro list*
  ┃ _Lista de textpro
  ┠⊷️ *${prefix}Textpro (code + Texto)*
  ┃ _Ex : ${prefix}Textpro 55 Adopt me Trades_
  ┗━━━━━━━━━━━━━━━━━━━━
  *〘 IMAGENES 〙*
  ┏━━━━━━━━━━━━━━━━━━━━
  ┠⊷️ *${prefix}Cogan*
  ...
  *OVO :* _${Ovo}_`,
  ...
  pok = await getBuffer(nimek)
  Lxa.sendMessage(from, pok, image, {
	quoted: mek, caption: `Adopt me Trades-Bot`
  })
  ...
  */
  ...
  exec(`ffmpeg -i ${anum} ${ran}`, (err) => {
	...
	Lxa.sendMessage(from, buffer, video, {
  quoted: mek, caption: 'Adopt me Trades'
	})
	fs.unlinkSync(ran)
  })
  break
  ...
  //--Convert stiker to image
				  case 'toimg':
					  ...
					  exec(`ffmpeg -i ${medimg} ${ran}`, (err) => {
						  ...
						  buffer = fs.readFileSync(ran)
						  Lxa.sendMessage(from, buffer, image, {quoted: mek, caption: 'Adopt me Trades-Bot'})
						  fs.unlinkSync(ran)
					  })
					  break
